module.exports = function getConfigs(req, res) {
    //TODO: написать автосборку по названиям директорий, если они есть
    const config = {
        tasks: [
            {
                taskName: 'rle',
            ...
            {
                taskName: 'bruteforce',
                taskFullName: 'Поиск подстроки в строке. Алгоритм грубой силы',
            ...
            },
            {
                ...
                description: 'Необходимо написать две функции: cipher(input, n) и decipher(input): ' +
                    ...
                    'Из каждой функции нужно возвращать результат – зашифрованную или расшифрованную строку.' +
                    ' Результат функции decipher должен совпадать с входными данными функции cipher.\n\n',
                taskFiles: [
                    {
                        fileId: 'mainSolution',
                        fileName: 'Файл с решением'
